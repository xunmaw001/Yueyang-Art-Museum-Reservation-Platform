...
public class MeishuguanLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public MeishuguanLiuyanEntity() {

	}

	public MeishuguanLiuyanEntity(T t) {
		try {
    ...
    public String toString() {
        return "MeishuguanLiuyan{" +
            ", id=" + id +
            ", meishuguanId=" + meishuguanId +
            ", yonghuId=" + yonghuId +
            ", meishuguanLiuyanText=" + meishuguanLiuyanText +
