...
public class MeishuguanCollectionView extends MeishuguanCollectionEntity implements Serializable {
	...
	*/
	...
	private String meishuguanCollectionValue;
	...
	public MeishuguanCollectionView() {

	}

	public MeishuguanCollectionView(MeishuguanCollectionEntity meishuguanCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, meishuguanCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getMeishuguanCollectionValue() {
		return meishuguanCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setMeishuguanCollectionValue(String meishuguanCollectionValue) {
		this.meishuguanCollectionValue = meishuguanCollectionValue;
	}
	...
	public String toString() {
		return "MeishuguanCollectionView{" +
			", meishuguanCollectionValue=" + meishuguanCollectionValue +
