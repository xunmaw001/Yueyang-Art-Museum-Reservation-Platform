...
public class MeishuguanOrderView extends MeishuguanOrderEntity implements Serializable {
	...
	*/
	...
	private String meishuguanOrderValue;
	...
	public MeishuguanOrderView() {

	}

	public MeishuguanOrderView(MeishuguanOrderEntity meishuguanOrderEntity) {
		try {
			BeanUtils.copyProperties(this, meishuguanOrderEntity);
	...
	* 获取： 订单类型的值
	*/
	public String getMeishuguanOrderValue() {
		return meishuguanOrderValue;
	}
	/**
	* 设置： 订单类型的值
	*/
	public void setMeishuguanOrderValue(String meishuguanOrderValue) {
		this.meishuguanOrderValue = meishuguanOrderValue;
	}
	...
	public String toString() {
		return "MeishuguanOrderView{" +
			", meishuguanOrderValue=" + meishuguanOrderValue +
