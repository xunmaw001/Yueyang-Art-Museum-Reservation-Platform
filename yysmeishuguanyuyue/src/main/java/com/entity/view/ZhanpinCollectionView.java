...
public class ZhanpinCollectionView extends ZhanpinCollectionEntity implements Serializable {
	...
	*/
	...
	private String zhanpinCollectionValue;
	...
	public ZhanpinCollectionView() {

	}

	public ZhanpinCollectionView(ZhanpinCollectionEntity zhanpinCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, zhanpinCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getZhanpinCollectionValue() {
		return zhanpinCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setZhanpinCollectionValue(String zhanpinCollectionValue) {
		this.zhanpinCollectionValue = zhanpinCollectionValue;
	}
	...
	public String toString() {
		return "ZhanpinCollectionView{" +
			", zhanpinCollectionValue=" + zhanpinCollectionValue +
