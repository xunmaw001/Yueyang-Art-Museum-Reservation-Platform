        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.zhanpinVideo" label="视频" prop="zhanpinVideo">
                        <file-upload
                            tip="点击上传视频"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.zhanpinVideo?$base.url+ruleForm.zhanpinVideo:''"
                            @change="zhanpinVideoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.zhanpinVideo" label="视频" prop="zhanpinVideo">
                            <video :src="$base.url+ruleForm.zhanpinVideo" width="100" height="100" controls="controls">
                            </video>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="展品类型" prop="zhanpinTypes">
                        <el-select v-model="ruleForm.zhanpinTypes" :disabled="ro.zhanpinTypes" placeholder="请选择展品类型">
                            <el-option
                                v-for="(item,index) in zhanpinTypesOptions"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="展品热度" prop="meishuguanClicknum">
                       <el-input v-model="ruleForm.meishuguanClicknum"
                                 placeholder="展品热度" clearable  :readonly="ro.meishuguanClicknum"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="展品热度" prop="meishuguanClicknum">
                           <el-input v-model="ruleForm.meishuguanClicknum"
                                     placeholder="展品热度" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.zhanpinContent"  label="展品详情" prop="zhanpinContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.zhanpinContent" label="展品详情" prop="zhanpinContent">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   zhanpinPhoto: [
                              { required: true, message: '展品封面不能为空', trigger: 'blur' },
                          ],
                   zhanpinVideo: [
                   ...
                   meishuguanClicknum: [
                              { required: true, message: '展品热度不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   zhanpinContent: [
                              { required: true, message: '展品详情不能为空', trigger: 'blur' },
                          ],
                   zhanpinDelete: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=zhanpin_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.zhanpinTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            zhanpinVideoUploadChange(fileUrls){
                this.ruleForm.zhanpinVideo = fileUrls;
                this.addEditUploadStyleChange()
            },
