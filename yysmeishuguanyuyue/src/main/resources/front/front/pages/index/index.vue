...
<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;"
    ...
    <view class="right-content" @tap="onPageTap('zhanpin')"
          :style="{fontSize:'32rpx',color:'rgba(0, 0, 0, 1)'}">
        查看更多
    </view>
</view>
<view class="list-box style4"
    ...
    <view class="list-item">
        <view v-if="zhanpinList.length > 0"
              @tap="onDetailTap('zhanpin',zhanpinList[0].id)" class="box box1"
            ...
            <div
                    ...
                    class="title hide1">{{zhanpinList[0].zhanpinName}}
            </div>
            <image
                    ...
                    :src="baseUrl+zhanpinList[0].zhanpinPhoto">
            </image>
        </view>
        <view class="list-item-body" style="flex: 1;">
            <view v-if="zhanpinList.length > 1"
                  @tap="onDetailTap('zhanpin',zhanpinList[1].id)" class="box box2"
                ...
                <div
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                        class="title hide1">{{zhanpinList[1].zhanpinName}}
                </div>
                <image
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                        class="list-item-image" mode="aspectFill"
                        :src="baseUrl+zhanpinList[1].zhanpinPhoto">
                </image>
            </view>
            <view v-if="zhanpinList.length > 2"
                  @tap="onDetailTap('zhanpin',zhanpinList[2].id)" class="box box3"
                ...
                <div
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                        class="title hide1">{{zhanpinList[2].zhanpinName}}
                </div>
                <image
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                        class="list-item-image" mode="aspectFill"
                        :src="baseUrl+zhanpinList[2].zhanpinPhoto">
                </image>
            </view>
        </view>
    </view>
    <view class="list-item">
        <view v-if="zhanpinList.length > 3"
              @tap="onDetailTap('zhanpin',zhanpinList[3].id)" class="box box4"
            ...
            <div
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                    class="title hide1">{{zhanpinList[3].zhanpinName}}
            </div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+zhanpinList[3].zhanpinPhoto">
            </image>
        </view>
        <view v-if="zhanpinList.length > 4"
              @tap="onDetailTap('zhanpin',zhanpinList[4].id)" class="box box5"
            ...
            <div
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                    class="title hide1">{{zhanpinList[4].zhanpinName}}
            </div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+zhanpinList[4].zhanpinPhoto">
            </image>
        </view>
    </view>
    <view v-if="zhanpinList.length > 5" @tap="onDetailTap('zhanpin',zhanpinList[5].id)"
          class="box box6"
        ...
        <div
                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                class="title hide1">{{zhanpinList[5].zhanpinName}}
        </div>
        <image
                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                class="list-item-image" mode="aspectFill"
                :src="baseUrl+zhanpinList[5].zhanpinPhoto">
        </image>
    </view>
</view>
...
<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;"
    ...
    <view class="right-content" @tap="onPageTap('meishuguan')"
          :style="{fontSize:'32rpx',color:'rgba(0, 0, 0, 1)'}">
        查看更多
    </view>
</view>
<view class="list-box style4"
      :style='{"padding":"20rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
    <view class="list-item">
        <view v-if="meishuguanList.length > 0"
              @tap="onDetailTap('meishuguan',meishuguanList[0].id)" class="box box1"
              :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 4% 20rpx 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"48%","borderStyle":"solid","height":"400rpx"}'>
            <div
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                    class="title hide1">{{meishuguanList[0].meishuguanName}}
            </div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+meishuguanList[0].meishuguanPhoto">
            </image>
        </view>
        <view class="list-item-body" style="flex: 1;">
            <view v-if="meishuguanList.length > 1"
                  @tap="onDetailTap('meishuguan',meishuguanList[1].id)" class="box box2"
                  :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 0 20rpx","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"190rpx"}'>
                <div
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                        class="title hide1">{{meishuguanList[1].meishuguanName}}
                </div>
                <image
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                        class="list-item-image" mode="aspectFill"
                        :src="baseUrl+meishuguanList[1].meishuguanPhoto">
                </image>
            </view>
            <view v-if="meishuguanList.length > 2"
                  @tap="onDetailTap('meishuguan',meishuguanList[2].id)" class="box box3"
                  :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"190rpx"}'>
                <div
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                        class="title hide1">{{meishuguanList[2].meishuguanName}}
                </div>
                <image
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                        class="list-item-image" mode="aspectFill"
                        :src="baseUrl+meishuguanList[2].meishuguanPhoto">
                </image>
            </view>
        </view>
    </view>
    <view class="list-item">
        <view v-if="meishuguanList.length > 3"
              @tap="onDetailTap('meishuguan',meishuguanList[3].id)" class="box box4"
              :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 4% 20rpx 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"48%","borderStyle":"solid","height":"160rpx"}'>
            <div
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                    class="title hide1">{{meishuguanList[3].meishuguanName}}
            </div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+meishuguanList[3].meishuguanPhoto">
            </image>
        </view>
        <view v-if="meishuguanList.length > 4"
              @tap="onDetailTap('meishuguan',meishuguanList[4].id)" class="box box5"
              :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 0 20rpx 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"48%","borderStyle":"solid","height":"160rpx"}'>
            <div
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                    class="title hide1">{{meishuguanList[4].meishuguanName}}
            </div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+meishuguanList[4].meishuguanPhoto">
            </image>
        </view>
    </view>
    <view v-if="meishuguanList.length > 5" @tap="onDetailTap('meishuguan',meishuguanList[5].id)"
          class="box box6"
          :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"160rpx"}'>
        <div
                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                class="title hide1">{{meishuguanList[5].meishuguanName}}
        </div>
        <image
                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                class="list-item-image" mode="aspectFill"
                :src="baseUrl+meishuguanList[5].meishuguanPhoto">
        </image>
    </view>
</view>
...
<script>
    ...
    export default {
        ...
        async onShow() {
            ...
            let zhanpin = await this.$api.requestCondition('zhanpin','gexingtuijian',zhanpinVal);

            this.zhanpinList = zhanpin.data.list
            this.zhanpinList.forEach(function(item, index) {
                if(item.zhanpinContent != null && item.zhanpinContent != "" && item.zhanpinContent != "null"){
                    item.zhanpinContent =item.zhanpinContent.replace(/<img [^>]*src=['"]([^'"]+)[^>]*>/gi,"");//替换图片
                }
            });
            ...
            let meishuguan = await this.$api.requestCondition('meishuguan','gexingtuijian',meishuguanVal);

            this.meishuguanList = meishuguan.data.list
            this.meishuguanList.forEach(function(item, index) {
                if(item.meishuguanContent != null && item.meishuguanContent != "" && item.meishuguanContent != "null"){
                    item.meishuguanContent =item.meishuguanContent.replace(/<img [^>]*src=['"]([^'"]+)[^>]*>/gi,"");//替换图片
                }
            });
