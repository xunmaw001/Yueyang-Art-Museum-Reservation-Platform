        ...
        <form class="app-update-pv">
			<view
                ...
                <textarea
                        ...
                        v-model='ruleForm.meishuguanLiuyanText' placeholder="留言内容"></textarea>
            </view>
    ...
    export default {
        ...
        async onLoad(options) {
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`meishuguanLiuyan`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.meishuguanId){
                this.ruleForm.meishuguanId = options.meishuguanId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            async onSubmitTap() {
			if ((!this.ruleForm.meishuguanLiuyanText)) {
                this.$utils.msg(`留言内容不能为空`);
                return
            }
                if (this.ruleForm.id) {
                    await this.$api.update(`meishuguanLiuyan`, this.ruleForm);
                } else {
                    await this.$api.save(`meishuguanLiuyan`, this.ruleForm);
                }
